...
Visit [http://laravel-test.dev/](http://laravel-test.dev/) and you should see the home page. Check your browser's error console
for any load errors or javascript errors.

Visit [http://laravel-test.dev/tests/](http://laravel-test.dev/tests/) to run the automated acceptance tests.
